...
def arg_parse():
    ...
    # Datasets parameters
    parser.add_argument('--data_dir', type=str, default='data/val/img/', 
                    help="root path to data directory")
    parser.add_argument('--output_dir', type = str, default = 'hw2_best_output/')
    ...
    parser.add_argument('--resume', type=str, default='model_improved.pth.tar', 
